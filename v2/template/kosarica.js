...
export default class Kosarica {
  ...
  static kosaricaUkupno(dnevni, dvostrukiDnevni, razinaPrava, obveznikPDV) {
    ...
    const tableKosaricaRow =`
    <tr>
      <td colspan="4" class="text-right align-middle">Ukupno: ${toEuro.num(cijenaUkupno)} € | ${zaokruziNaDvije(cijenaUkupno)} Kn</td>
    </tr>
    <tr>
      <td colspan="4" class="text-right align-middle">Ukupni iznos subvencije: ${subvencijaUkupno > _dvostrukiDnevni ? `${toEuro.num(_dvostrukiDnevni)} € | ${_dvostrukiDnevni} Kn` : `${toEuro.num(subvencijaUkupno)} € | ${zaokruziNaDvije(subvencijaUkupno)} Kn`}</td>
    </tr>
    <tr>
      <td colspan="4" class="text-right align-middle h5">Ukupno za platiti: ${subvencijaUkupno > _dvostrukiDnevni ? `${toEuro.num(cijenaUkupno - _dvostrukiDnevni)} € | ${zaokruziNaDvije(cijenaUkupno - _dvostrukiDnevni)} Kn` : `${toEuro.num(cijenaUkupno - subvencijaUkupno)} € | ${zaokruziNaDvije(cijenaUkupno - subvencijaUkupno)} Kn`}</td>
    </tr>`;
    ...
    if (obveznikPDV) {
      ...
      const tableObracunRow = `
      <tr>
        <td colspan="4" class="text-right align-middle">Ukupni iznos poreza: ${toEuro.num(porezUkupno)} € | ${zaokruziNaDvije(porezUkupno)} Kn</td>
      </tr>
      `;
