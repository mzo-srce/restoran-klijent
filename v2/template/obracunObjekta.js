...
import {appStatus, datumi, divStatusCard, doAjax, dtOptions, hideStatusCard, to, ugasiTImere, toEuro} from '../../Shared/js/asyncAjax';
...
export default class ObracunObjekta {
  ...
  async dohvatiPodatke(datumVrijemeOd, datumVrijemeDo) {
    ...
    <tr>
      <td class="align-middle">Ukupni iznos računa (sa PDV-om i bez subvencije): ${toEuro.num(RacuniUkupno)} € | ${RacuniUkupno} Kn</td>
    </tr>
    <tr>
      <td class="align-middle">Ukupni iznos subvencije: ${toEuro.num(SubvencijaUkupno)} € | ${SubvencijaUkupno} Kn</td>
    </tr>
    <tr>
      <td class="align-middle">Ukupni iznos poreza: ${toEuro.num(PorezUkupno)} € | ${PorezUkupno} Kn</td>
    </tr>
    <tr>
