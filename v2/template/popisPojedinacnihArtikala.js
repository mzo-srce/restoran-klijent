  ...
  async initDataTable() {
    ...
    $('#popisArtikalaTable').DataTable( {
      ...
      'columns': [
        ...
        {'data': 'SubvencijaArtikla', 'searchable': false, 'render': (data) => `${toEuro.num(data)} € <hr class="m-0 p-0"/> ${data} Kn`},
        {'data': 'PostoParticipacije', 'searchable': false},
        {'data': 'CijenaArtikla', 'searchable': false, 'render': (data) => `${toEuro.num(data)} € <hr class="m-0 p-0"/> ${data} Kn`},
