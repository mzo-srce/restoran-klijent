      ...
      'columns': [
        ...
        },
        {
          ...
          'render': ({RacunOdbijen, NaplataPoruka}) => {
            return `${RacunOdbijen ? `<button type="button" class="btn btn-md btn-dark-f" data-toggle="popover" title="Razlog odbitka računa" data-content="${NaplataPoruka}">odbijen</button>` : 'prihvaćen'}`;
          },
        },
        {
          'data': null,
