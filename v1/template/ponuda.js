...
import {appStatus, datumi, divChildCard, divStatusCard, doAjax, dtOptions, hideChildCard, hideStatusCard, to, ugasiTImere} from '../../Shared/js/asyncAjax';
...
export default class Ponuda {
  ...
  async spojiArtiklePonuda(artikli, ponuda) {
    ...
    // console.log(spojiArtiklePonuda);
    // console.log([...spojiArtiklePonuda, ...spojiMeniPonuda]);
    ...
    $('#popisArtikalaTable').DataTable( {
      ...
      'buttons': {
        ...
        'buttons': [
          ...
          {
            extend: 'print',
            text: '<span class="material-icons md-18 lh-0">print</span> Ispis cjenika',
            title: 'Cjenik artikala studentske prehrane',
      ...
      'columns': [
        ...
        {'data': 'Subvencija', 'searchable': false},
        {'data': 'PostoParticipacije', 'searchable': false},
        {'data': 'Cijena', 'searchable': false},
