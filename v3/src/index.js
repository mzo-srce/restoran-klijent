...
class App {
  constructor() {
    ...
    this.korisnickoIme = '';
    // this.server = 'https://issp.srce.hr/testrestoranapi';
    this.server = 'https://restoranapi.issp.srce.hr';
        ...
        <div class="col-lg-8 offset-lg-2 col-xl-4 offset-xl-4">
            <div class="card z-depth-1 rounded-0 my-5">
                <div class="card-header bg-f-dark text-center rounded-0 py-5">
                    <img src="https://www.srce.unizg.hr/logo/Logo-Srce-main-HRV_negativ_1.png" class="srceBigLogo img-fluid" alt="srce logo header" height="200" width="400">
                </div>
                ...
                <div class="card-footer bg-f-dark text-center rounded-0">
                    <img src="https://www.srce.unizg.hr/logo/Logo-Srce_negativ_1.png" class="srceLogoFooter" alt="srce logo footer" height="20" width="60">
                </div>
            </div>
        </div>
    </div>
    ...
    $('#prijavaSustav').on('click', async (e) => {
      ...
      if (window.navigator.onLine) {
        ...
        if (err && (err.status === 0 || err.status === 503)) {
          ...
          localStorage.promjenaSmjeraCitanja = false;
  ...
  async dohvatiPodatkeOffline(kontrolniBrojDjelatnika) {
    ...
    if (!localStorage.offlineStudent) {
      const student = {
        ...
        Poruka: null,
        SubvencijaDnevniIznosRaspoloziv: '5.34',
        SubvencijaDvostrukiDnevniIznos: '10.68',
