        ...
        <div class="container-fluid p-0">
            ...
            <div class="collapse navbar-collapse flex-column align-items-start ml-0" id="navbarCollapse">
                ...
                <ul class="navbar-nav mb-auto mt-0 mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="pl-5 nav-link d-none showLoader" id="posaljiRacune" aria-label="pošalji račune">
                            Pošalji offline račune - <span id="posaljiRacuneDodatak" class="brojOfflineRacuna">0</span>
                        </a>
                    </li>
                    ...
                    ${!autoblagajna ? `
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                ${admin ? `<a class="pl-5 nav-link showLoader" id="offlineRacuni" aria-label="offline računi">Offline računi</a>` : ''}
                            </div>
                        </li>
