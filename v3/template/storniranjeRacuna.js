...
import {appStatus, datumi, divStatusCard, doAjax, dtOptions, hideStatusCard, to, ugasiTImere, toEuro, zaokruziNaDvije, toHrk} from '../../Shared/js/asyncAjax';
    ...
    $('#popisRacunaTable').DataTable( {
      ...
      'columns': [
        ...
        },
        {
          'data': null,
          'searchable': false,
          'render': ({ObveznikFiskalizacije, RacunOdgovor}) => {
            if (ObveznikFiskalizacije && RacunOdgovor.HasJIR) {
              return 'DA';
            }
            return 'NE';
          },
