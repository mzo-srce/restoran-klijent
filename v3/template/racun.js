...
import {toEuro, toHrk, zaokruziNaDvije} from '../../Shared/js/asyncAjax';
...
export default class Racun {
  ...
  static async postaviCore(data, storno) {
    ...
    const artikliTablica = () => {
      ...
      Artikli.forEach(({NazivArtikla, KolicinaArtikla, CijenaArtikla, CijenaArtiklaSKolicinom, PostoParticipacije}) => {
        row += `<tr>
          <td class="text-left align-middle">${NazivArtikla} (${PostoParticipacije}%) ${parseInt(KolicinaArtikla, 10) > 1 ? `<br/>(1 = ${CijenaArtikla} €)` : ''}</td>
            ...
            <table class="table table-borderd w-100 mb-0">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-right align-bottom text-nowrap">Cijena [€]</th>
                ...
                <tfoot>
                  <tr>
                    <td colspan="4" class="text-right align-middle">Ukupno: ${zaokruziNaDvije(Number(UkupniIznosSubvencije) + Number(UkupniIznosZaPlatiti))} € </td>
                  </tr>
                  <tr>
                    <td colspan="4" class="text-right align-middle">Ukupni iznos subvencije: ${UkupniIznosSubvencije} €</td>
                  </tr>
                  <tr>
                    <td colspan="4" class="text-right align-middle h5">Ukupno za platiti: ${UkupniIznosZaPlatiti} €</td>
                  </tr>
                </tfoot>
            </table>
        </div>
                ...
                <table class="table table-borderd w-100 mb-0">
                    <thead>
                        <tr>
                            ...
                            <td scope="col" class="text-right align-bottom">Osnovica [€]</td>
                            <td scope="col" class="text-right align-bottom">Iznos [€]</td>
                        </tr>
                    </thead>
                    <tbody>
                      ${poreziTablica()}
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="4" class="text-right align-middle">Ukupni iznos poreza: ${UkupniIznosPoreza} €</td>
                      </tr>
                    </tfoot>
                </table>
            </div>
  ...
  static async offlinePrint() {
    ...
    printJS({
      ...
      'style': 'body{color:#000!important}#print-offline-receipt{color:#000!important,font-size:10px,font-family:"Times New Roman"}.d-print-none{display:none!important}.d-print-block{display:block!important}.align-middle{vertical-align:middle!important}.align-bottom{vertical-align:bottom!important}.text-right{text-align:right!important}.text-left{text-align:left!important}.text-center{text-align:center!important}table th{font-weight:700!important}table.table td,table.table th{padding-top:.2rem!important;padding-bottom:.2rem!important}.table td,.table>thead td,.table>thead th{padding:.2rem!important;vertical-align:bottom!important;border-top:1px solid #000!important}.table>thead td,.table>thead th{padding:.2rem!important;vertical-align:bottom!important;border-bottom:1px solid #000!important}.p-0{padding:0!important}.pb-2,.py-2{padding-bottom:.5rem!important}.pt-2,.py-2{padding-top:.5rem!important}.m-0{margin:0!important}.table-responsive{display:block!important;width:100%!important}.w-100,table{width:100%!important}.border-top{border-top:1px dashed #000}.border-bottom{border-bottom:1px dashed #000}.small,small{font-size:80%;font-weight:400}.h5,h5{font-size:1.25rem}.srceLogoFooter{height: 20px}',
      'type': 'html',
      'scanStyles': false,
      'onPrintDialogClose': () => $('#racun-holder').remove(),
    });
